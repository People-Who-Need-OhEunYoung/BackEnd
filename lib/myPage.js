...
exports.myPage = async function(req, res) {
    ...
    try {
        ...
        let sql = `SELECT nick_name, credit, cur_poke_id, user_exp FROM user WHERE bakjoon_id=?`;
        ...
        const [resolvedRows] = await conn.execute(sql, [decoded.id, 1]);
...
exports.resolvedProblems = async function(req, res) {
    ...
    try {
        ...
        const [result] = await conn.execute(sql, [decoded.id, 1]);
