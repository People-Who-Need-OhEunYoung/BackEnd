...
exports.reviewList = async function(req, res) {
    ...
    try {
        ...
        const finalResults = countResults.map(countResult => {
            const masterResult = masterResults.find(m => m.review_id === countResult.review_id);
            return {
                review_id: countResult.review_id,
                cur_num: countResult.count,
...
exports.reviewListTest = async function(req, res) {
